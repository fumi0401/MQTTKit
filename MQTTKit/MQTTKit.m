...
- (void) connectWithCompletionHandler:(void (^)(MQTTConnectionReturnCode code))completionHandler {
    ...
    if (self.cafile && mosquitto_tls_set(mosq, [self.cafile cStringUsingEncoding:NSUTF8StringEncoding],[self.cafile cStringUsingEncoding:NSUTF8StringEncoding], [self.capath cStringUsingEncoding:NSUTF8StringEncoding], [self.certfile cStringUsingEncoding:NSUTF8StringEncoding], [self.keyfile cStringUsingEncoding:NSUTF8StringEncoding] , NULL)) {
